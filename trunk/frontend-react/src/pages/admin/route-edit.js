...
class RouteEdit extends Component {
    ...
    componentWillMount() {
        ...
        if (params.get('id')) {
            dispatch(routeA.initUpdate({originalUrl, action: 'update'}));
        } else {
            dispatch(routeA.initUpdate({originalUrl, action: 'insert'}));
        }
    ...
    componentDidMount() {
        ...
        document.title = routes.action === 'update' ? 'Update Route' : 'Insert Route';
    }
                    ...
                    <Segment>
                        ...
                        <Form>
                            <Form.Group className="form-group" widths='equal'>
                                <Form.Input name='routeName' value={current.routeName}
                                            onChange={this.handleChangeInput.bind(this)} fluid
                                            label={<label>Route name<strong
                                                className="error-validate">*</strong></label>} placeholder='Route name'
                            ...
                            <Form.Group className="form-group" widths='equal'>
                                <Form.Input fluid name='routeKey' value={current.routeKey}
                            ...
                            <Form.Group inline>
                                <Form.Checkbox label="All" value="all"
                            ...
                            <Form.Group widths='equal'>
                                <Form.Checkbox toggle onChange={this.handleParent.bind(this)} checked={current.isParent}
                                               label='Is parent'/>
                            </Form.Group>
