...
import {Form, Header, Label, Segment, Tab} from 'semantic-ui-react';
...
class UserEdit extends Component {
    ...
    componentWillMount() {
        ...
        if (params.get('id')) {
            dispatch(userA.initUpdate({originalUrl, action: 'update'}));
        } else {
            dispatch(userA.initUpdate({originalUrl, action: 'insert'}));
        }
    }
    ...
    componentDidMount() {
        ...
        document.title = action === 'update' ? 'Cập nhật Tài khoản' : 'Thêm mới Tài khoản';
        ...
        const panes = [
            {
                ...
                render: () => <Tab.Pane>
                    <Form>
                        ...
                        <Form.Group className="form-group" widths='equal'>
                            <Form.Input name='email' value={current.email} onChange={this.handleChangeInput.bind(this)}
    ...
    render() {
        ...
        let title = action === 'update' ? 'Cập nhật Tài khoản' : 'Thêm mới Tài khoản';
                    ...
                    <Segment>
                        <Header>{title}</Header>
                        {
                            action === 'insert' ? (<Form>
                                ...
                                <Form.Group widths='equal'>
                                    <Form.Checkbox toggle onChange={this.handleCompany.bind(this)}
