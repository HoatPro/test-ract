...
class Layouts extends Component {
    ...
    handleStageMouseUp = (e) => {
        const {layouts = {}, dispatch} = this.props;
        const {current = {}} = layouts;
        const {drawMode = false, isDrawing = false} = current;
    ...
    onSelect(name) {
        this.props.dispatch(layoutA.updateCurrent('current', {
    ...
    handleEditRackInfo() {
        ...
        const {current = {}, racks = {}} = layouts;
        // dispatch(layoutA.handleUpdateRow(find));
        history.push(prevURL + '/categories/rack-edit?id=' + current.rackId);

    }

    handleAddRack() {
        const {layouts = {}, dispatch, history} = this.props;
        const {current = {}, racks = {}} = layouts;
        let query = [];
        ...
        history.push(prevURL + '/categories/rack-edit?' + query.join('&'));
        // history.push(prevURL + '/categories/rack-edit');
    }
    ...
    handleViewRack() {
        ...
        const {current = {}, racks = {}} = layouts;
        if (current.rackId) {
            history.push(prevURL + '/categories/rack-view?id=' + current.rackId);
        }
    }
