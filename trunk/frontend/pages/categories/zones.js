...
import DrawRect from "../../src/components/Shapes/Rect";
...
class Zones extends Component {
    ...
    render() {
        ...
        _.forEach(zones.list, (item, i) => {
            ...
            temp.push({
                cell: (<Fragment>
                    <Link href={prevURL + '/categories/zone-edit?id=' + id} >
                    ...
                    <Segment>
                        ...
                        <Grid className='grid-toolbar' doubling stackable>
                            ...
                            <Grid.Column floated='right' textAlign="right" computer={3} largeScreen={3} tablet={5} moblie={8}>
                                ...
                                <Link href={prevURL + "/categories/zone-edit"}><Button primary>Add</Button></Link>
                            </Grid.Column>
                        </Grid>
                        <CustomTable
                            header={header}
